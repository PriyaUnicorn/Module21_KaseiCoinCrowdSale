...
7. Compile and test the updated contract by completing following steps:
    ...
    * View your Balance tokens in Remix. In Remix, click Add Token, add wei Value to see your Balance.  

Screen shot from Depolyment.

Step1

![](ReadMe_images/WeiValue.png)

Step2

![](ReadMe_images/OldBalance.png)

Step3

![](ReadMe_images/NewBalance.png)
